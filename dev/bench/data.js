    ...
    "Component benchmarks": [
      ...
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 43.572542150000004,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 14.024261947155676,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.222073720683824,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03494431782183378,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 94.31382534999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.96263959112691,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.2903848388706862,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.053858028028245145,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 71.92534479999998,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.892882819203965,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.850512101775561,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04102041338750144,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 25.974011722635034,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.9305344583495057,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.036790155497003874,
            "unit": "ms"
          },
          {
            "name": "select - median",
            "value": 35.940878999999995,
            "unit": "ms"
          },
          {
            "name": "select - p(95)",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 24.82876713487946,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 4.087504025938312,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "c77121e17a0238175ef677d856680096ed3ec655",
          "message": "chore(deps): Bump hoverkraft-tech/compose-action from 2.4.1 to 2.4.2 (#874)\n\nBumps\n[hoverkraft-tech/compose-action](https://github.com/hoverkraft-tech/compose-action)\nfrom 2.4.1 to 2.4.2.\n<details>\n<summary>Release notes</summary>\n<p><em>Sourced from <a\nhref=\"https://github.com/hoverkraft-tech/compose-action/releases\">hoverkraft-tech/compose-action's\nreleases</a>.</em></p>\n<blockquote>\n<h2>v2.4.2</h2>\n<h2>Release Summary</h2>\n<p>Fix: docker-compose error objects are now formatted into readable\nmessages for clearer debugging.\nDocs: refreshed Actions and workflows documentation to reflect current\nbehavior.</p>\n<p>Internal: dependency maintenance across the GitHub Actions stack,\nincluding the github-actions-dependencies group,\n<code>@​octokit/action</code>, and js-yaml.</p>\n<h2>Breaking change(s)</h2>\n<p>There is no breaking change.</p>\n<h2>What's Changed</h2>\n<ul>\n<li>docs: update actions and workflows documentation by <a\nhref=\"https://github.com/hoverkraft-bot\"><code>@​hoverkraft-bot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/189\">hoverkraft-tech/compose-action#189</a></li>\n<li>chore(deps): bump the github-actions-dependencies group with 3\nupdates by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/190\">hoverkraft-tech/compose-action#190</a></li>\n<li>chore(deps): bump the github-actions-dependencies group with 2\nupdates by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/192\">hoverkraft-tech/compose-action#192</a></li>\n<li>docs: update actions and workflows documentation by <a\nhref=\"https://github.com/hoverkraft-bot\"><code>@​hoverkraft-bot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/193\">hoverkraft-tech/compose-action#193</a></li>\n<li>chore(deps): bump the github-actions-dependencies group with 3\nupdates by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/195\">hoverkraft-tech/compose-action#195</a></li>\n<li>chore(deps): bump <code>@​octokit/action</code> from 8.0.2 to 8.0.4\nby <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/194\">hoverkraft-tech/compose-action#194</a></li>\n<li>chore(deps-dev): bump js-yaml from 3.14.1 to 3.14.2 by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/197\">hoverkraft-tech/compose-action#197</a></li>\n<li>chore(deps): bump the github-actions-dependencies group across 1\ndirectory with 10 updates by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/199\">hoverkraft-tech/compose-action#199</a></li>\n<li>docs: update actions and workflows documentation by <a\nhref=\"https://github.com/hoverkraft-bot\"><code>@​hoverkraft-bot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/200\">hoverkraft-tech/compose-action#200</a></li>\n<li>fix: format docker-compose error objects as readable messages by <a\nhref=\"https://github.com/Copilot\"><code>@​Copilot</code></a> in <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/204\">hoverkraft-tech/compose-action#204</a></li>\n<li>chore(deps): bump the github-actions-dependencies group across 1\ndirectory with 10 updates by <a\nhref=\"https://github.com/dependabot\"><code>@​dependabot</code></a>[bot]\nin <a\nhref=\"https://redirect.github.com/hoverkraft-tech/compose-action/pull/205\">hoverkraft-tech/compose-action#205</a></li>\n</ul>\n<p><strong>Full Changelog</strong>: <a\nhref=\"https://github.com/hoverkraft-tech/compose-action/compare/v2...v2.4.2\">https://github.com/hoverkraft-tech/compose-action/compare/v2...v2.4.2</a></p>\n</blockquote>\n</details>\n<details>\n<summary>Commits</summary>\n<ul>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/248470ecc5ed40d8ed3d4480d8260d77179ef579\"><code>248470e</code></a>\nchore(deps): bump the github-actions-dependencies group across 1\ndirectory wi...</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/5d59cf29d8c7f4252f326db690cf044c6d617569\"><code>5d59cf2</code></a>\nfix: format docker-compose error objects as readable messages</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/e9bb59d7946e1da8111c9d47acd36018c6b0ab0a\"><code>e9bb59d</code></a>\nchore: add agents instructions</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/67242320753dafe060804a8bc2e4917644a9ff4d\"><code>6724232</code></a>\ndocs: update actions and workflows documentation</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/f1193bc5098d465840d24708db36713b0e86822e\"><code>f1193bc</code></a>\nci: enable codecov for test coverage</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/175bf4a0615ecf24e579d7ab548bb7fabe195eb8\"><code>175bf4a</code></a>\nchore(deps): bump the github-actions-dependencies group across 1\ndirectory wi...</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/99742562043424900d77fbe5655b3bb95540ff91\"><code>9974256</code></a>\nchore(deps-dev): bump js-yaml from 3.14.1 to 3.14.2</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/2c655a3602eeee00c12d1f4edd41f7af43baf2e9\"><code>2c655a3</code></a>\nchore(deps): bump <code>@​octokit/action</code> from 8.0.2 to 8.0.4</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/2feed3a086d4e53bcb2495366629234766865e5e\"><code>2feed3a</code></a>\nchore(deps): bump the github-actions-dependencies group with 3\nupdates</li>\n<li><a\nhref=\"https://github.com/hoverkraft-tech/compose-action/commit/0c4c8ad01be62610d5f501b04c694bf86ea953b0\"><code>0c4c8ad</code></a>\nchore: improve devcontainer config</li>\n<li>Additional commits viewable in <a\nhref=\"https://github.com/hoverkraft-tech/compose-action/compare/v2.4.1...v2.4.2\">compare\nview</a></li>\n</ul>\n</details>\n<br />\n\n\n[![Dependabot compatibility\nscore](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=hoverkraft-tech/compose-action&package-manager=github_actions&previous-version=2.4.1&new-version=2.4.2)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)\n\nDependabot will resolve any conflicts with this PR as long as you don't\nalter it yourself. You can also trigger a rebase manually by commenting\n`@dependabot rebase`.\n\n[//]: # (dependabot-automerge-start)\n[//]: # (dependabot-automerge-end)\n\n---\n\n<details>\n<summary>Dependabot commands and options</summary>\n<br />\n\nYou can trigger Dependabot actions by commenting on this PR:\n- `@dependabot rebase` will rebase this PR\n- `@dependabot recreate` will recreate this PR, overwriting any edits\nthat have been made to it\n- `@dependabot merge` will merge this PR after your CI passes on it\n- `@dependabot squash and merge` will squash and merge this PR after\nyour CI passes on it\n- `@dependabot cancel merge` will cancel a previously requested merge\nand block automerging\n- `@dependabot reopen` will reopen this PR if it is closed\n- `@dependabot close` will close this PR and stop Dependabot recreating\nit. You can achieve the same result by closing it manually\n- `@dependabot show <dependency name> ignore conditions` will show all\nof the ignore conditions of the specified dependency\n- `@dependabot ignore this major version` will close this PR and stop\nDependabot creating any more for this major version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this minor version` will close this PR and stop\nDependabot creating any more for this minor version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this dependency` will close this PR and stop\nDependabot creating any more for this dependency (unless you reopen the\nPR or upgrade to it yourself)\n\n\n</details>\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2025-12-08T15:44:42Z",
          "tree_id": "a65352ad2cc3596b30b1df80362d920055fbd17e",
          "url": "https://github.com/hasura/ndc-postgres/commit/c77121e17a0238175ef677d856680096ed3ec655"
        },
        "date": 1765209457390,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 45.818985000000005,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 15.414742360686649,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.342733786773675,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.0380924327171331,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
            "value": 70.79476600000001,
            "unit": "ms"
          },
          {
            "name": "select-order-by - p(95)",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 54.33236524606687,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.1787231369843738,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05373176944213416,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 31.65052427011272,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.348762229096948,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.039810460417137775,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 30.914367039192438,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.7527617235061577,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.035892091951050614,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 60.803014399999995,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 26.71785961937451,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 4.234205338627202,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.0386479841187368,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 46.60783224999999,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 15.836620845651604,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.292410770294241,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.036306863504749376,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 96.96605294999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 50.771091752600285,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.222642701289729,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.055111244764810705,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 76.42401025000001,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.9644881291372,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 7.897832075511253,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04355420238743353,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - p(95)",
            "value": 61.510711099999966,
            "unit": "ms"
          },
          {
            "name": "select-where - connection acquisition time",
            "value": 26.889677158808773,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.7089261681337433,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.034034341090854535,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 53.76479419999997,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 24.13044653364658,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.4630563190589,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.033495121076174354,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 41.547106599999985,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 12.670218539379242,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.536438377935749,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.034328204562726346,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.65000542070312,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.0941216181832871,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.050137609104996955,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 71.39742539999997,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.773305933415493,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.885307958621688,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.03916934393839598,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 25.426834073518357,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 4.11214235657642,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.034817197625207234,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 55.47018619999999,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 24.52953822125441,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.746577756114082,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.03253102490244519,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 44.641198999999965,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 14.141783213543714,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.625020257979301,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03520721848105652,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 94.30983059999998,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.26696072556715,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.2627958281745393,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05089836904875042,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
            "value": 40.732465000000005,
            "unit": "ms"
          },
          {
            "name": "select-variables - p(95)",
            "value": 68.21781924999995,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.576056110716824,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.375766528609585,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.03930853090383353,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 26.185976279588274,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.7569885370857037,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.037651365591051845,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 55.951866399999986,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 25.098889180051433,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.6257312338926546,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
      ...
      },
      {
        "commit": {
          ...
          "distinct": false,
          "id": "fffd5f86dad980deca4669078ab43ee2cb2d25d8",
          "message": "chore(deps): Bump rust-toolchain from 1.90.0 to 1.91.1 (#873)\n\nBumps [rust-toolchain](https://github.com/rust-lang/rust) from 1.90.0 to\n1.91.1.\n<details>\n<summary>Release notes</summary>\n<p><em>Sourced from <a\nhref=\"https://github.com/rust-lang/rust/releases\">rust-toolchain's\nreleases</a>.</em></p>\n<blockquote>\n<h2>Rust 1.91.1</h2>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/148322\">Enable\nfile locking support in illumos</a>. This fixes Cargo not locking the\nbuild directory on illumos.</li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/148363\">Fix\n<code>wasm_import_module</code> attribute cross-crate</a>. This fixes\nlinker errors on WASM targets.</li>\n</ul>\n<h2>Rust 1.91.0</h2>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Language</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/143764\">Lower\npattern bindings in the order they're written and base drop order on\nprimary bindings' order</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144066\">Stabilize\ndeclaration of C-style variadic functions for <code>sysv64</code>,\n<code>win64</code>, <code>efiapi</code>, and <code>aapcs</code>\nABIs</a>. This brings these ABIs in line with the C ABI: variadic\nfunctions can be declared in extern blocks but not defined.</li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/144322\">Add\n<code>dangling_pointers_from_locals</code> lint to warn against dangling\npointers from local variables</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144369\">Upgrade\n<code>semicolon_in_expressions_from_macros</code> from warn to\ndeny</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144402\">Stabilize\nLoongArch32 inline assembly</a></li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/144531\">Add\nwarn-by-default <code>integer_to_ptr_transmutes</code> lint against\ninteger-to-pointer transmutes</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144542\">Stabilize\n<code>sse4a</code> and <code>tbm</code> target features</a></li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/139451\">Add\n<code>target_env = &quot;macabi&quot;</code> and <code>target_env =\n&quot;sim&quot;</code> cfgs</a> as replacements for the\n<code>target_abi</code> cfgs with the same values.</li>\n</ul>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Compiler</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144804\">Don't warn\non never-to-any <code>as</code> casts as unreachable</a></li>\n</ul>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Platform Support</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/143031\">Promote\n<code>aarch64-pc-windows-gnullvm</code> and\n<code>x86_64-pc-windows-gnullvm</code> to Tier 2 with host tools.</a>\nNote: llvm-tools and MSI installers are missing but will be added in\nfuture releases.</li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/145682\">Promote\n<code>aarch64-pc-windows-msvc</code> to Tier 1</a></li>\n</ul>\n<p>Refer to Rust's <a\nhref=\"https://doc.rust-lang.org/rustc/platform-support.html\">platform\nsupport page</a> for more information on Rust's tiered platform\nsupport.</p>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Libraries</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/115746\">Print\nthread ID in panic message</a></li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/132087\">Fix\noverly restrictive lifetime in <code>core::panic::Location::file</code>\nreturn type</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/139357\">Guarantee\nparameter order for <code>_by()</code> variants of <code>min</code> /\n<code>max</code>/ <code>minmax</code> in <code>std::cmp</code></a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144330/\">Document\nassumptions about <code>Clone</code> and <code>Eq</code> traits</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144210\"><code>std::thread</code>:\nReturn error if setting thread stack size fails</a> This used to panic\nwithin the standard library.</li>\n</ul>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Stabilized APIs</h2>\n<ul>\n<li><a\nhref=\"https://doc.rust-lang.org/stable/std/path/struct.Path.html#method.file_prefix\"><code>Path::file_prefix</code></a></li>\n</ul>\n<!-- raw HTML omitted -->\n</blockquote>\n<p>... (truncated)</p>\n</details>\n<details>\n<summary>Changelog</summary>\n<p><em>Sourced from <a\nhref=\"https://github.com/rust-lang/rust/blob/main/RELEASES.md\">rust-toolchain's\nchangelog</a>.</em></p>\n<blockquote>\n<h1>Version 1.91.1 (2025-11-10)</h1>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/148322\">Enable\nfile locking support in illumos</a>. This fixes Cargo not locking the\nbuild directory on illumos.</li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/148363\">Fix\n<code>wasm_import_module</code> attribute cross-crate</a>. This fixes\nlinker errors on WASM targets.</li>\n</ul>\n<h1>Version 1.91.0 (2025-10-30)</h1>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Language</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/143764\">Lower\npattern bindings in the order they're written and base drop order on\nprimary bindings' order</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144066\">Stabilize\ndeclaration of C-style variadic functions for <code>sysv64</code>,\n<code>win64</code>, <code>efiapi</code>, and <code>aapcs</code>\nABIs</a>.\nThis brings these ABIs in line with the C ABI: variadic functions can be\ndeclared in extern blocks but not defined.</li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/144322\">Add\n<code>dangling_pointers_from_locals</code> lint to warn against dangling\npointers from local variables</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144369\">Upgrade\n<code>semicolon_in_expressions_from_macros</code> from warn to\ndeny</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144402\">Stabilize\nLoongArch32 inline assembly</a></li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/144531\">Add\nwarn-by-default <code>integer_to_ptr_transmutes</code> lint against\ninteger-to-pointer transmutes</a></li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144542\">Stabilize\n<code>sse4a</code> and <code>tbm</code> target features</a></li>\n<li><a href=\"https://redirect.github.com/rust-lang/rust/pull/139451\">Add\n<code>target_env = &quot;macabi&quot;</code> and <code>target_env =\n&quot;sim&quot;</code> cfgs</a> as replacements for the\n<code>target_abi</code> cfgs with the same values.</li>\n</ul>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Compiler</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/144804\">Don't warn\non never-to-any <code>as</code> casts as unreachable</a></li>\n</ul>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<h2>Platform Support</h2>\n<ul>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/143031\">Promote\n<code>aarch64-pc-windows-gnullvm</code> and\n<code>x86_64-pc-windows-gnullvm</code> to Tier 2 with host tools.</a>\nNote: llvm-tools and MSI installers are missing but will be added in\nfuture releases.</li>\n<li><a\nhref=\"https://redirect.github.com/rust-lang/rust/pull/145682\">Promote\n<code>aarch64-pc-windows-msvc</code> to Tier 1</a></li>\n</ul>\n<p>Refer to Rust's <a\nhref=\"https://doc.rust-lang.org/rustc/platform-support.html\">platform\nsupport page</a>\nfor more information on Rust's tiered platform support.</p>\n<p><!-- raw HTML omitted --><!-- raw HTML omitted --></p>\n<p>Libraries</p>\n<!-- raw HTML omitted -->\n</blockquote>\n<p>... (truncated)</p>\n</details>\n<details>\n<summary>Commits</summary>\n<ul>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/ed61e7d7e242494fb7057f2657300d9e77bb4fcb\"><code>ed61e7d</code></a>\nAuto merge of <a\nhref=\"https://redirect.github.com/rust-lang/rust/issues/148593\">#148593</a>\n- pietroalbini:ea-1.91.1, r=BoxyUwU</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/e42a4ca53b274dbfd94ea8f712dd9715d2e8fea5\"><code>e42a4ca</code></a>\nbump version number</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/ae5f6ed3e4ded2d28ae3b76d7409bba41dd9c572\"><code>ae5f6ed</code></a>\nupdate release notes</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/279ca7e533eac3915f8508e1a4a04c0a0a24d18f\"><code>279ca7e</code></a>\nFix <code>wasm_import_module</code> attribute cross-crate</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/1a7eff402486156dd4925ec0ca7709bc85d6672f\"><code>1a7eff4</code></a>\nenable flock for illumos</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/f8297e351a40c1439a467bbbb6879088047f50b3\"><code>f8297e3</code></a>\nAuto merge of <a\nhref=\"https://redirect.github.com/rust-lang/rust/issues/148216\">#148216</a>\n- cuviper:stable-next, r=BoxyUwU,jackh726</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/faf3e0b589d2d1ec79b11948f7b90f860cce6575\"><code>faf3e0b</code></a>\nFurther revert <code>Deref for Cow</code> to its 1.90.0 state</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/40c4f6dfcd5ff247ef7fb5bd1f16a6bfceaf054b\"><code>40c4f6d</code></a>\nAuto merge of <a\nhref=\"https://redirect.github.com/rust-lang/rust/issues/148179\">#148179</a>\n- cuviper:stable-next, r=cuviper</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/be999adba7cadc171c1f79fde2e527518775c7ec\"><code>be999ad</code></a>\n1.91.0 stable release</li>\n<li><a\nhref=\"https://github.com/rust-lang/rust/commit/e4f50310ceffe983f95624e9611714c7fafabf1e\"><code>e4f5031</code></a>\nfix(len_zero): don't eagerly call <code>GenericArgs::type_at</code> (<a\nhref=\"https://redirect.github.com/rust-lang/rust/issues/15660\">#15660</a>)</li>\n<li>Additional commits viewable in <a\nhref=\"https://github.com/rust-lang/rust/compare/1.90.0...1.91.1\">compare\nview</a></li>\n</ul>\n</details>\n<br />\n\n\n[![Dependabot compatibility\nscore](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=rust-toolchain&package-manager=rust_toolchain&previous-version=1.90.0&new-version=1.91.1)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)\n\nDependabot will resolve any conflicts with this PR as long as you don't\nalter it yourself. You can also trigger a rebase manually by commenting\n`@dependabot rebase`.\n\n[//]: # (dependabot-automerge-start)\n[//]: # (dependabot-automerge-end)\n\n---\n\n<details>\n<summary>Dependabot commands and options</summary>\n<br />\n\nYou can trigger Dependabot actions by commenting on this PR:\n- `@dependabot rebase` will rebase this PR\n- `@dependabot recreate` will recreate this PR, overwriting any edits\nthat have been made to it\n- `@dependabot merge` will merge this PR after your CI passes on it\n- `@dependabot squash and merge` will squash and merge this PR after\nyour CI passes on it\n- `@dependabot cancel merge` will cancel a previously requested merge\nand block automerging\n- `@dependabot reopen` will reopen this PR if it is closed\n- `@dependabot close` will close this PR and stop Dependabot recreating\nit. You can achieve the same result by closing it manually\n- `@dependabot show <dependency name> ignore conditions` will show all\nof the ignore conditions of the specified dependency\n- `@dependabot ignore this major version` will close this PR and stop\nDependabot creating any more for this major version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this minor version` will close this PR and stop\nDependabot creating any more for this minor version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this dependency` will close this PR and stop\nDependabot creating any more for this dependency (unless you reopen the\nPR or upgrade to it yourself)\n\n\n</details>\n\n---------\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>\nCo-authored-by: Daniel Harvey <danieljamesharvey@gmail.com>",
          "timestamp": "2025-12-15T13:13:17Z",
          "tree_id": "4498ec534e22db7a1faf5b3799f6385217d60e6e",
          "url": "https://github.com/hasura/ndc-postgres/commit/fffd5f86dad980deca4669078ab43ee2cb2d25d8"
        },
        "date": 1765805564994,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 12.834821558875259,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.085162499683115,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03448453981835218,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.828074821074786,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.2196895238682615,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05588351635592433,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
            "value": 47.396919499999996,
            "unit": "ms"
          },
          {
            "name": "select-variables - p(95)",
            "value": 76.53531029999999,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 32.24068369866789,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 5.6882878308338505,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04080408228910311,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 26.154494599575294,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 4.455976818761059,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.03529046662121253,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 25.28428786428438,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.410525634070943,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.03593410754386463,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          {
            "name": "select-by-pk - median",
            "value": 24.182311499999997,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - p(95)",
            "value": 41.926106499999996,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 14.302847705330187,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.054797646128289,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.032961910896026125,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 93.07449659999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.77007175748126,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.1513520562531667,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05162398988938657,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.800131792670705,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.631108458547175,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.037277393328750054,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 27.80260991836218,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.5141227400118282,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.032104162080976606,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 56.502160199999985,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 24.28451392782673,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 4.029435327647988,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.035409274802585655,
            "unit": "ms"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7b5aea60d30623601e0fcc5a9931b2d177640689",
          "message": "chore(deps): Bump ref-cast from 1.0.24 to 1.0.25 (#882)\n\n[//]: # (dependabot-start)\n⚠️  **Dependabot is rebasing this PR** ⚠️ \n\nRebasing might not happen immediately, so don't worry if this takes some\ntime.\n\nNote: if you make any changes to this PR yourself, they will take\nprecedence over the rebase.\n\n---\n\n[//]: # (dependabot-end)\n\nBumps [ref-cast](https://github.com/dtolnay/ref-cast) from 1.0.24 to\n1.0.25.\n<details>\n<summary>Release notes</summary>\n<p><em>Sourced from <a\nhref=\"https://github.com/dtolnay/ref-cast/releases\">ref-cast's\nreleases</a>.</em></p>\n<blockquote>\n<h2>1.0.25</h2>\n<ul>\n<li>Use differently named __private module per patch release (<a\nhref=\"https://redirect.github.com/dtolnay/ref-cast/issues/52\">#52</a>)</li>\n</ul>\n</blockquote>\n</details>\n<details>\n<summary>Commits</summary>\n<ul>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/8cea9d561e44ec4ebaf4de1ba64bedfdf2944138\"><code>8cea9d5</code></a>\nRelease 1.0.25</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/686210fcb1657f9594b45b92572a96646e72a1b8\"><code>686210f</code></a>\nMerge pull request <a\nhref=\"https://redirect.github.com/dtolnay/ref-cast/issues/52\">#52</a>\nfrom dtolnay/private</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/b8126782b04d76aa289d9bf716203043638871b9\"><code>b812678</code></a>\nUse differently named __private module per patch release</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/2d9777a66aaea5b7a74b0a5d2248548c4f5dedcb\"><code>2d9777a</code></a>\nRaise minimum tested compiler to rust 1.76</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/dd2e77dd6787ef38668219cdb6f1648cba7d076b\"><code>dd2e77d</code></a>\nOpt in to generate-macro-expansion when building on docs.rs</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/8151e360a610ab22058287316971c0544fde383d\"><code>8151e36</code></a>\nRaise required compiler to Rust 1.61</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/2e02859160a4cd5b7dc7b9bd226f1c1c7360d5d9\"><code>2e02859</code></a>\nEnforce trybuild &gt;= 1.0.108</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/d16d5e7ff7a4b670a70e6a67386bad8fe1f4c7f4\"><code>d16d5e7</code></a>\nUpdate ui test suite to nightly-2025-08-24</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/44666e0d82da44af935ab1a8c23040318d1d38a8\"><code>44666e0</code></a>\nUpdate actions/checkout@v4 -&gt; v5</li>\n<li><a\nhref=\"https://github.com/dtolnay/ref-cast/commit/c3357d688c16f5a7af570c857954f5b672db43f8\"><code>c3357d6</code></a>\nRevert &quot;Pin nightly toolchain used for miri job&quot;</li>\n<li>Additional commits viewable in <a\nhref=\"https://github.com/dtolnay/ref-cast/compare/1.0.24...1.0.25\">compare\nview</a></li>\n</ul>\n</details>\n<br />\n\n\n[![Dependabot compatibility\nscore](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=ref-cast&package-manager=cargo&previous-version=1.0.24&new-version=1.0.25)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)\n\nDependabot will resolve any conflicts with this PR as long as you don't\nalter it yourself. You can also trigger a rebase manually by commenting\n`@dependabot rebase`.\n\n[//]: # (dependabot-automerge-start)\n[//]: # (dependabot-automerge-end)\n\n---\n\n<details>\n<summary>Dependabot commands and options</summary>\n<br />\n\nYou can trigger Dependabot actions by commenting on this PR:\n- `@dependabot rebase` will rebase this PR\n- `@dependabot recreate` will recreate this PR, overwriting any edits\nthat have been made to it\n- `@dependabot merge` will merge this PR after your CI passes on it\n- `@dependabot squash and merge` will squash and merge this PR after\nyour CI passes on it\n- `@dependabot cancel merge` will cancel a previously requested merge\nand block automerging\n- `@dependabot reopen` will reopen this PR if it is closed\n- `@dependabot close` will close this PR and stop Dependabot recreating\nit. You can achieve the same result by closing it manually\n- `@dependabot show <dependency name> ignore conditions` will show all\nof the ignore conditions of the specified dependency\n- `@dependabot ignore this major version` will close this PR and stop\nDependabot creating any more for this major version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this minor version` will close this PR and stop\nDependabot creating any more for this minor version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this dependency` will close this PR and stop\nDependabot creating any more for this dependency (unless you reopen the\nPR or upgrade to it yourself)\n\n\n</details>\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2025-12-15T13:17:09Z",
          "tree_id": "c5a9f5d7862298603764b335a642a7e36c4b9b47",
          "url": "https://github.com/hasura/ndc-postgres/commit/7b5aea60d30623601e0fcc5a9931b2d177640689"
        },
        "date": 1765805679835,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 39.860559249999994,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 13.32141669267689,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 5.434584432026286,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03273835375349561,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 92.69912584999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 48.294558443961094,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.1591643728241579,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.04786251793220596,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 26.429267391685276,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 6.196270328063218,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.037003737908097765,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 25.292906092382974,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 4.039463206600484,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.035292494762712956,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 23.7487458403785,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.844300481458756,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
      ...
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 42.72325139999999,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 13.026307473174041,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.214686905381095,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.042451837815390574,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - p(95)",
            "value": 99.40630359999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 45.04068531888582,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.894189940955485,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05505620264288049,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 28.492508773066774,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 5.1769154420589345,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04581336564970725,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 26.868901754914273,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.9390834896021367,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.0381106054024386,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 25.194112295632966,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.3627367294170547,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.03791465952741483,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          {
            "name": "select-by-pk - median",
            "value": 24.951894000000003,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - p(95)",
            "value": 43.606103499999996,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 13.643354678416772,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 5.708804488556597,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.04171322167518531,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
            "value": 74.72013799999999,
            "unit": "ms"
          },
          {
            "name": "select-order-by - p(95)",
            "value": 120.79070540000001,
            "unit": "ms"
          },
          {
            "name": "select-order-by - connection acquisition time",
            "value": 48.73147024937323,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.9507978970864954,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05492084923285558,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
            "value": 47.352307499999995,
            "unit": "ms"
          },
          {
            "name": "select-variables - p(95)",
            "value": 75.75155099999999,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 29.690615102153252,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 4.565911148144465,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.047652573030472316,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - p(95)",
            "value": 64.60624589999999,
            "unit": "ms"
          },
          {
            "name": "select-where - connection acquisition time",
            "value": 27.599372186472266,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.578444636359599,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.03851595969840381,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 26.189269884877636,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 2.6194725910342562,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
      ...
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 14.38559945259566,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.135775012346254,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.04140034946033163,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 44.175284000432306,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 1.02497804156161,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05685587870023266,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
            "value": 47.055198000000004,
            "unit": "ms"
          },
          {
            "name": "select-variables - p(95)",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 28.730993602658803,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 5.137937598818336,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.047068455736248155,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 27.278410086964122,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.4419258518551032,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.04049428768083861,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 25.699251869550597,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 2.8841911037824026,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.04042173759661024,
            "unit": "ms"
          }
        ]
      },
      {
        "commit": {
          "author": {
            "email": "rohankmr414@gmail.com",
            "name": "Rohan K",
            "username": "rohankmr414"
          },
          "committer": {
            "email": "noreply@github.com",
            "name": "GitHub",
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 42.22101299999998,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 11.815633317903679,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.77656879236044,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03896968103312691,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 44.463266716192145,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.9947081185655193,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05330505804684909,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 87.20417499999999,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 32.44190739337645,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 4.917807678082873,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04312282191725902,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
            "value": 41.508221000000006,
            "unit": "ms"
          },
          {
            "name": "select-where - p(95)",
            "value": 64.92604424999999,
            "unit": "ms"
          },
          {
            "name": "select-where - connection acquisition time",
            "value": 26.798548980014065,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.6659612906034553,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.03247365575187233,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - connection acquisition time",
            "value": 24.843319181146022,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 3.3083506629694597,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.03850855892388334,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 50.092743999999996,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 14.042709310783266,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 7.9886011712245235,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.04912581119396411,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
            "value": 71.29579000000001,
            "unit": "ms"
          },
          {
            "name": "select-order-by - p(95)",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 44.736246365745366,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.9640272317818201,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.06716219614565092,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 32.60507008772055,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 4.185000272805333,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.05208074163425508,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - p(95)",
            "value": 66.07458940000001,
            "unit": "ms"
          },
          {
            "name": "select-where - connection acquisition time",
            "value": 25.85700628696746,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 3.810978538316732,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.04221328560783436,
            "unit": "ms"
          },
          {
            "name": "select - median",
          ...
          {
            "name": "select - p(95)",
            "value": 63.04023179999997,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 26.31947871995876,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 2.608181765229027,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.04299050852854273,
            "unit": "ms"
          }
        ]
      },
      {
        ...
        "benches": [
          ...
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 10.253356799788149,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 5.682344745664354,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.03652067664708486,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 49.81044064195009,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.6859218893565,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.05536789059029964,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - connection acquisition time",
            "value": 21.371530251229096,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 5.629843064576722,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.04171916675188972,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
            "value": 35.019346999999996,
            "unit": "ms"
          },
          {
            "name": "select-where - p(95)",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 22.09507259891197,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.768318880504477,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.037936080901411456,
            "unit": "ms"
          },
          {
            "name": "select - median",
            "value": 33.497131499999995,
            "unit": "ms"
          },
          {
            "name": "select - p(95)",
            "value": 53.502797099999995,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 21.791511350215952,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 2.4770939058539163,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.03635950361004991,
            "unit": "ms"
          }
        ]
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e6c9355ce2572971d9645fa74adb5f98df654a0b",
          "message": "chore(deps): Bump ravsamhq/notify-slack-action from 042f29088bb3bdbda5b4ff7b4818466a277fa8f7 to be814b201e233b2dc673608aa46e5447c8ab13f2 (#899)\n\nBumps\n[ravsamhq/notify-slack-action](https://github.com/ravsamhq/notify-slack-action)\nfrom 042f29088bb3bdbda5b4ff7b4818466a277fa8f7 to\nbe814b201e233b2dc673608aa46e5447c8ab13f2.\n<details>\n<summary>Commits</summary>\n<ul>\n<li>See full diff in <a\nhref=\"https://github.com/ravsamhq/notify-slack-action/compare/042f29088bb3bdbda5b4ff7b4818466a277fa8f7...be814b201e233b2dc673608aa46e5447c8ab13f2\">compare\nview</a></li>\n</ul>\n</details>\n<br />\n\n\nDependabot will resolve any conflicts with this PR as long as you don't\nalter it yourself. You can also trigger a rebase manually by commenting\n`@dependabot rebase`.\n\n[//]: # (dependabot-automerge-start)\n[//]: # (dependabot-automerge-end)\n\n---\n\n<details>\n<summary>Dependabot commands and options</summary>\n<br />\n\nYou can trigger Dependabot actions by commenting on this PR:\n- `@dependabot rebase` will rebase this PR\n- `@dependabot recreate` will recreate this PR, overwriting any edits\nthat have been made to it\n- `@dependabot show <dependency name> ignore conditions` will show all\nof the ignore conditions of the specified dependency\n- `@dependabot ignore this major version` will close this PR and stop\nDependabot creating any more for this major version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this minor version` will close this PR and stop\nDependabot creating any more for this minor version (unless you reopen\nthe PR or upgrade to it yourself)\n- `@dependabot ignore this dependency` will close this PR and stop\nDependabot creating any more for this dependency (unless you reopen the\nPR or upgrade to it yourself)\n\n\n</details>\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-04-08T09:04:29Z",
          "tree_id": "02f3af8f25a276d72890993c667ab60da813b61b",
          "url": "https://github.com/hasura/ndc-postgres/commit/e6c9355ce2572971d9645fa74adb5f98df654a0b"
        },
        "date": 1775639689681,
        "tool": "customSmallerIsBetter",
        "benches": [
          ...
          {
            "name": "select-by-pk - p(95)",
            "value": 44.57490220000001,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - connection acquisition time",
            "value": 13.509692993989004,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - request time - (query + acquisition)",
            "value": 6.539216385606503,
            "unit": "ms"
          },
          {
            "name": "select-by-pk - processing time",
            "value": 0.04149100907219659,
            "unit": "ms"
          },
          {
            "name": "select-order-by - median",
          ...
          {
            "name": "select-order-by - connection acquisition time",
            "value": 43.66808154371388,
            "unit": "ms"
          },
          {
            "name": "select-order-by - request time - (query + acquisition)",
            "value": 0.9227503967951236,
            "unit": "ms"
          },
          {
            "name": "select-order-by - processing time",
            "value": 0.057279689073232644,
            "unit": "ms"
          },
          {
            "name": "select-variables - median",
          ...
          {
            "name": "select-variables - p(95)",
            "value": 77.52478999999998,
            "unit": "ms"
          },
          {
            "name": "select-variables - connection acquisition time",
            "value": 29.15727958556171,
            "unit": "ms"
          },
          {
            "name": "select-variables - request time - (query + acquisition)",
            "value": 4.941855607463516,
            "unit": "ms"
          },
          {
            "name": "select-variables - processing time",
            "value": 0.043860913539957094,
            "unit": "ms"
          },
          {
            "name": "select-where - median",
          ...
          {
            "name": "select-where - connection acquisition time",
            "value": 26.623157836578425,
            "unit": "ms"
          },
          {
            "name": "select-where - request time - (query + acquisition)",
            "value": 2.5911065128935356,
            "unit": "ms"
          },
          {
            "name": "select-where - processing time",
            "value": 0.03998901462445743,
            "unit": "ms"
          },
          {
            "name": "select - median",
            "value": 39.427071999999995,
            "unit": "ms"
          },
          {
            "name": "select - p(95)",
            "value": 61.082513750000004,
            "unit": "ms"
          },
          {
            "name": "select - connection acquisition time",
            "value": 25.12938553045066,
            "unit": "ms"
          },
          {
            "name": "select - request time - (query + acquisition)",
            "value": 2.556348304959645,
            "unit": "ms"
          },
          {
            "name": "select - processing time",
            "value": 0.04019045011572578,
            "unit": "ms"
          }
        ]
      }
