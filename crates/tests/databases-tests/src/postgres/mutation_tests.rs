...
mod basic {
    ...
    async fn insert_custom_dog() {
        ...
        let mutation_result = run_mutation(router.clone(), "insert_custom_dog").await;
    ...
    async fn insert_defaults() {
        ...
        let mutation_result = run_mutation(router.clone(), "insert_defaults").await;
    ...
    async fn insert_enum() {
        ...
        let mutation_result = run_mutation(router.clone(), "insert_enum").await;
    ...
    async fn insert_update_custom_dog() {
        ...
        let mutation_result = run_mutation(router.clone(), "insert_update_custom_dog").await;
...
mod negative {
    ...
    async fn insert_custom_dog_missing_column() {
        let ndc_metadata =
            FreshDeployment::create(common::CONNECTION_URI, common::CHINOOK_NDC_METADATA_PATH)
                .await
                .unwrap();
        ...
        let mutation_result = run_mutation_fail(
            router.clone(),
            "insert_custom_dog_missing_column",
    ...
    async fn insert_custom_dog_predicate_fail() {
        let ndc_metadata =
            FreshDeployment::create(common::CONNECTION_URI, common::CHINOOK_NDC_METADATA_PATH)
                .await
                .unwrap();
        ...
        let mutation_result = run_mutation_fail(
            router.clone(),
            "insert_custom_dog_predicate_fail",
            StatusCode::FORBIDDEN,
        )
        .await;
    ...
    #[tokio::test(flavor = "multi_thread")]
    async fn insert_enum_invalid_label() {
        let ndc_metadata =
            FreshDeployment::create(common::CONNECTION_URI, common::CHINOOK_NDC_METADATA_PATH)
                .await
                .unwrap();
